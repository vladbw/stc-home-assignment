...
import { PresentationsListPage } from './features/presentations-list/presentations-list-page';

// The editor/presentation js is only loaded on demand
const PresentationEditorPage = lazy(() =>
  import('./features/presentation-editor/presentation-editor-page').then((m) => ({ default: m.PresentationEditorPage })),
);
const PresentationViewerPage = lazy(() =>
  import('./features/presentation-viewer/presentation-viewer-page').then((m) => ({ default: m.PresentationViewerPage })),
);
