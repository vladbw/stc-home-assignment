 ...
 *
 * Phase 8 adds: activePageId, selectedContentId.
 * Future phases will extend: drag/resize state, undo/redo history, etc.
 */
...
export const useEditorStore = create<EditorState>((set) => ({
  ...
  reset: () =>
    set({ activePageId: null, selectedContentId: null, editingContentId: null }),
}));
